...
const STORE = {
    ...
    QA: [
        
        {
            ...
            correct: 'A suite of enterprise cloud computing services that runs on the same infrastructure that Google uses internally for its end-user products'
        }, 
        {
            ...
            correct: 'Launching, provisioning and decommissioning virtual machines (VMs) on demand'
        }
    ]
}
